...
function logOutProbs = get_log_likelihood_for_new_data_given_state_noPCA(new_data, bsds_model, target_state)
...
for ns = 1:nSubjs
    col = 0; logQns = [];
        ...
        %tempXm = Xm{t}(:,(ns-1)*n/nSubjs:(ns*n/nSubjs)); %shaozheng debug
